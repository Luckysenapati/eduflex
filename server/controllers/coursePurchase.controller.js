...
export const createCheckoutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `https://eduflex-6csh.onrender.com/course-progress/${courseId}`, // once payment successful redirect to course progress page
      cancel_url: `https://eduflex-6csh.onrender.com/course-detail/${courseId}`,
      metadata: {
        courseId: courseId,
        userId: userId,
      },
...
export const getAllPurchasedCourse = async (req, res) => {
  // export const getAllPurchasedCourse = async (_, res) => { i changed this to --new function ------------------------------------

  try {
    const purchasedCourse = await CoursePurchase.find({
      status: "completed",
      userId: req.id,  // new line add ---------------------------------------------------------------------------------------------------
    }).populate("courseId");
    if (!purchasedCourse) {
