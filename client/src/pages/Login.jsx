...
const Login = () => {
  ...
  const validateSignup = () => {
    ...
    if (!nameRegex.test(signupInput.name)) {
            ...
            <CardContent className="space-y-2">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) => changeInputHandler(e, "signup")}
                  placeholder="Eg. dibyajyoti@gmail.com"
                  required
                />
              </div>
              <div className="space-y-1">
        ...
        <TabsContent value="login">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Login using your credentials. After signup, you can log in here.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <div className="space-y-1">
